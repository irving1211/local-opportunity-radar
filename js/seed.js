...
export const EXAMPLE_LEADS = [
  {
    source: "craigslist-alert", sourceDetail: "gigs — labor/move", category: "home-service", urgency: "asap",
    title: "Need a plumber ASAP — kitchen sink leaking (Lawrence)",
  ...
  {
    source: "referral", sourceDetail: "Maria (regular customer)", category: "web", urgency: "this-week",
  ...
  {
    source: "facebook-group", sourceDetail: "Merrimack Valley Small Biz", category: "automation", urgency: "flexible",
  ...
  {
    source: "paste", sourceDetail: "Nextdoor post", category: "app", urgency: "flexible",
    title: "Custom scheduling tool for a cleaning company",
    location: "Boston, MA",
    contactRaw: "ops@brightclean.example",
    rawText: "We're a growing cleaning company and need a simple internal tool to assign jobs to crews, track which are done, and see the week at a glance. Nothing fancy but it has to be reliable. This is a real budget project — we know good software costs money.",
    budgetClue: "$3000-5000",
  },
  {
    source: "facebook-group", sourceDetail: "Side Hustle Flippers", category: "design", urgency: "flexible",
